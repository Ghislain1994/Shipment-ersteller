<?php
    if(isset($_POST['generate']))
    {
        ...
        //change the format date with point as separator
        $newEvDate = date("d.m.Y h:i:s", strtotime($evDate));
        ...
        $tmstime = $xml->createElement("TMS-Timestamp",  $newEvDate);
        ...
        $eventTime = $xml->createElement("Timestamp", $newEvDate);
        $submission = $xml->createElement("Submission", $newEvDate);
